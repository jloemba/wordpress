...
*
* Ce widget découle du plugin monplugin.php
*/
class Ma_Newsletter_Widget extends WP_Widget
{
	...
	{
		/* On attribut de le nom du plugin qui s'affichera dans le back-office.
			http://localhost/wordpress/wp-admin/widgets.php
		*/
		parent::__construct('ma_newsletter', 'Newsletter', array('description'
		 	=> 'Pour afficher le formulaire d\'inscription à la mailing list'));
	}
